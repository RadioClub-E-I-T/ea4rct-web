...
<img src="/proyectos/Recreativa/maquina2.png" width="500" height="400">
<img src="/proyectos/Recreativa/maquina4.png" width="500" height="600">

* **Equipo de hardware**: Esta parte consistió, en el la fabricación del armazón, para ello se buscaron planos de arcades antiguas, intentando ser lo más files posibles a las que ya existían, sin embargo se decidieron llevar a cabo algunas modificaciones de tamaño, con el fin de optimizar espacio y permitir añadir el resto de funcionalidades nuevas que se querían implementar.
Para ello se usaron listones de madera de DM, un material resistente pero ligero que nos permitió hacer el armazón de una pieza, dándole un toque más clásicos y real.


<img src="/proyectos/Recreativa/maquina6.png" width="500" height="600">
<img src="/proyectos/Recreativa/maquina8.png" width="500" height="600">
<img src="/proyectos/Recreativa/maquina7.jpg" width="500" height="600">

Además se hizo una búsqueda exhaustiva para encontrar los mejores joysticks y botones del mercado
buscando una fiabilidad, y resistencia máxima. Manteniendo el mejor precio, para no salirnos del presupuesto.
<img src="/proyectos/Recreativa/maquina14.png" width="500" height="600">
<img src="/proyectos/Recreativa/maquina16.png" width="500" height="600">

## Lugar de realización

El desarrollo completo del proyecto se ha llevado a cabo en las instalaciones del radioclub, sin embargo dado la embergadura de la máquina, esta ha sido colocada y almacenada en el club de nuestros vecinos la delegación de estudiantes DAT, quedandose allí una vez realizada. Pudiendose ser movida en caso de necesidad, ante torneos de videojuegos o jornadas de bienvenidas.
...
| Concepto | Coste |
|---|---|
|Maderas armazón|165.53€|
|Joystick y botones|47.99€|
|Ordenador |DONADO|
|Disco duro interno| 43.41€ |
|Extras|69.7€|
| Software | Gratuito |
|||
|**TOTAL**| 326.63€|
